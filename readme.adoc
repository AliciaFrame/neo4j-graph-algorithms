...
We're hard at work improving and expanding our algorithms library, and while we sort out our code release process, please use the download center to find the most recent jar and release notes. *Our current version is **3.5.9.0**.*
